...
const VoteResultBar = (props) => {
  ...
  const { agreeCount, disagreeCount, clickAgreeButton, clickDisagreeButton } =
    props;
    ...
    <BarWrapper>
      <Background>
        <Highlight width={agreePercentageWidth}>
          ...
          >
            <Grid isFlex>
              <Grid margin="0px 8px 0px 0px" onClick={clickAgreeButton}>
                <svg
                  width="17"
                  height="16"
                  viewBox="0 0 17 16"
              ...
              <Text color={themeContext.colors.white}>{agreeCount}</Text>
            </Grid>
          </Grid>
        </Highlight>
        <Grid
        ...
        >
          <Grid isFlex>
            <Text color={themeContext.colors.white}>{disagreeCount}</Text>
            <Grid margin="0px 0px 0px 8px" onClick={clickDisagreeButton}>
              <svg
                width="17"
                height="16"
                viewBox="0 0 17 16"
...
VoteResultBar.propTypes = {
  ...
  clickAgreeButton: PropTypes.func,
  clickDisagreeButton: PropTypes.func,
};
